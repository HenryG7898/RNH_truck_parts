        ...
        <div class="lg:flex lg:items-center lg:justify-between">
            <div class="flex items-center justify-between">
                <div class="text-xl font-semibold text-gray-700 ">
                    <a class="flex flex-wrap text-2xl h-auto font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-red-600 dark:hover:text-gray-300" href="/">
{{--                        <img src="https://img.icons8.com/ios-glyphs/50/000000/airplane-take-off.png"/>--}}
                        <span class="mt-1 mx-3">RNH Trucks Parts & Accessories</span>
                    </a>
                </div>
